                ...
                <div class="card">
                        ...
                        <div class="media">
                            <div class="media-body">
                                <div class="form-group">
                                    <textarea rows="10" v-model="body" class="form-control" required-message="กรุณาใส่ของมูล" required></textarea>
                                </div>
                    ...
                    <div class="card-body" v-else>
                        <div class="card-title">
                            ...
                            <h1>{{ title }}</h1>
                                <div class="ml-auto">
                                <a href="/questions" class="btn btn-outline-secondary"> <i class="glyphicon glyphicon-arrow-left"></i> กลับไป </a>
                                </div>
                            </div>
                        </div>
                        <hr>
