            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-auto">
                        <a href="{{ route('questions.index') }}" class="btn btn-outline-secondary"> <i class="glyphicon glyphicon-arrow-left"></i> กลับไป </a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('questions.store') }}" method="post">
                        ...
                        <div class="form-group">
                            <label for="quesiont-title">หัวข้อคำถาม</label>
